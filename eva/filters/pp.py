...
from eva.filters.kdewrapper import KernelDensityWrapper
...
class PP:
    ...
    def _rf(self, args):
        ...
        for label in label_dict:
            ...
            self.category_stats[label][pre + "/rf"] = {
                "C": round(time.time() - tic + self.pre_category_stats[pre]["C"], 2)}  #
    ...
    def _dnn(self, args):
        ...
        for label in label_dict:
            ...
            if label not in self.category_stats:
                self.category_stats[label] = {}
            self.category_stats[label][pre + "/dnn"] = {
                "C": round(time.time() - tic + self.pre_category_stats[pre]["C"], 2)}
    ...
    def _svm(self, args):
        ...
        for label in label_dict:
            ...
            if len(np.unique(label)) == 1:
                ...
                if label not in self.category_stats:
                    self.category_stats[label] = {}
                self.category_stats[label][pre + "/svm"] = {
                    "C": round(time.time() - tic + self.pre_category_stats[pre]["C"], 2)}
        return
    ...
    def _kde(self, args):
        ...
        for label in label_dict:
            ...
            if label not in self.category_stats:
                self.category_stats[label] = {}
            self.category_stats[label][pre + "/kde"] = {
                "C": round(time.time() - tic + self.pre_category_stats[pre]["C"], 2)}
